...
# same as rpart_FinvsSin.R but with age predictors removed
#################
...
# age (X002 and X003) found to be missing in many cases; assume removal will help remove skew
d <- d[, !(names(d) %in% c("X002", "X003"))]
